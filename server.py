...
app=FastAPI(title='WaterPulse AI Agent API', version='8.3')
...
@app.get('/api/health')
def health():
    return {'status':'ok','app':'WaterPulse AI Agent','version':'8.3','deepseek_configured':deepseek_configured(),'deepseek_model':deepseek_model(),'field_contract':contract_summary(),'timestamp':now_iso()}
...
def agent_status():
    return {'status':'ok','agent_version':'8.3-chat-deepseek-field-governance',
